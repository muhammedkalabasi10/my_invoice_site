      ...
      >
        <TableContainer component={Paper} elevation={0}>
          <Table className={classes.table} aria-label="custom pagination table">
            <TableHead>
              <TableRow>
                <TableCell style={headerStyle}>Nummer</TableCell>
                <TableCell style={headerStyle}>Kundenname</TableCell>
                <TableCell style={headerStyle}>Gesamtsumme</TableCell>
                <TableCell style={headerStyle}>Datum Des Endes</TableCell>

                <TableCell style={headerStyle}>Status</TableCell>

                <TableCell style={headerStyle}>ändern</TableCell>
                <TableCell style={headerStyle}>Rechnung löschen</TableCell>
              </TableRow>
            </TableHead>
